...
class ReportService
{
    ...
    public function handleStockAdjustment( ProductHistory $history ): array
    {
        if ( in_array( $history->operation_type, [
            ...
            $message = __( 'A stock operation has recently been detected, however MPOS wasn\'t able to update the report accordingly. This occurs if the daily dashboard reference hasn\'t been created.' );
